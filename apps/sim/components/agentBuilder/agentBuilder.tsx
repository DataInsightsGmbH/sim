...
export function AgentBuilder({
  ...
  const { schemaDescription, setSchemaDescription, handleGenerateSchema, updatePromptValue } =
    useSchemaGenerator(
      storeDescription?.toString() || '',
      setSchema,
      setSchemaLoading,
      blockId,
      subBlockId
  ...
  return (
    <div className='flex h-full min-h-0 flex-1 flex-col gap-4 p-4'>
      <div className='grid h-full min-h-0 w-full grid-cols-2 gap-8'>
        <div className='grid h-full min-h-0 w-full grid-rows-3 gap-4 '>
          <DataField
